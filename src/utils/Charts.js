    ...
    return (
        <View style={{ width: ScreenWidth, height: rankEvaluationContainerHeight }}>
            <View style={[GlobalStyle.row_wrapper, { backgroundColor: 'lightgray', width: ScreenWidth, height: rankEvaluationRowHeight, alignItems: 'center' }]}>
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>Current Rank</Text></View>
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>Level Points</Text></View>
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>Next Rank</Text></View>
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>Active Period</Text></View>
            </View>
            <View style={[GlobalStyle.row_wrapper, { backgroundColor: tan, width: ScreenWidth, height: rankEvaluationRowHeight, alignItems: 'center' }]}>
                <View style={styles.rank_evaluation_item_x2}>
                    <Image source={require('../assets/images/icons/bronze.png')} />
                    <Text style={{ marginLeft: 5 }}>Bronze</Text>
                </View>
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>{` >= 60 and < 400`}</Text></View>
                <View style={styles.rank_evaluation_item}>
                    <Image source={require('../assets/images/icons/silver.png')} />
                    <Text style={{ marginLeft: 5 }}>Silver</Text>
                </View>
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>12 months</Text></View>
            </View>
            <View style={[GlobalStyle.row_wrapper, { backgroundColor: tan, width: ScreenWidth, height: rankEvaluationRowHeight, alignItems: 'center', marginLeft: rankEvaluationColWidth }]}>
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>{`>= 400`}</Text></View>
                <View style={styles.rank_evaluation_item}>
                    <Image source={require('../assets/images/icons/gold.png')} />
                    <Text style={{ marginLeft: 5 }}>Gold</Text>
                </View>
            ...
            <View style={[GlobalStyle.row_wrapper, { backgroundColor: tan, width: ScreenWidth, height: rankEvaluationRowHeight, alignItems: 'center' }]}>
                ...
                <View style={styles.rank_evaluation_item}><Text style={GlobalStyle.textCenter}>{`>= 340`}</Text></View>
                <View style={styles.rank_evaluation_item}>
                    <Image source={require('../assets/images/icons/gold.png')} />
                    <Text style={{ marginLeft: 5 }}>Gold</Text>
                </View>
...
const rankEvaluationColWidth = ScreenWidth / 4;
...
const styles = StyleSheet.create({
    ...
    rank_evaluation_item: {
        borderWidth: 0.5,
        borderColor: 'lightgray',
        width: rankEvaluationColWidth,
    ...
    rank_evaluation_item_x2: {
        borderWidth: 0.5,
        borderColor: 'lightgray',
        width: rankEvaluationColWidth,
        height: rankEvaluationRowHeight * 2,
        alignItems: 'center',
        justifyContent: 'center',
        backgroundColor: tan,
